...
A process flow chart showing the interconnectivity of the process can be found [here] (https://github.com/federal-geospatial-platform/fgp-metadata-proxy/tree/master/docs/P-T_FGP-TBS_XML-JSON_BUILDER_WORKSPACE_PROCESS_FLOW_STANDARD_v1.docx)
