...
REM ===========================================================================
SET NomApp=TEMPORAL_EXTENTS_MAPPER
SET fme=%FME2019%
...
REM First FME call to source ffs file that has twelve records; six with no start and end dates, three with start and end dates, two with end date only, one with start date only
set test_number=1
...
%fme% met\metrique_temporal_extents_mapper.fmw ^
--IN_FFS_FILE %source% ^
