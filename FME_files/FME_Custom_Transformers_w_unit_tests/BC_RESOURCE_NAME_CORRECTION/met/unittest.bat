...
REM ===========================================================================
SET NomApp=BC_RESOURCE_NAME_CORRECTION
SET fme=%FME2019%
...
REM First FME call,creating FFS File with fifteen compliant data records
set test_number=1
...
%fme% met\metrique_bc_resource_name_correction.fmw ^
--IN_FFS_FILE %source% ^
