...
REM ===========================================================================
SET NomApp=ON_GEOHUB_RESOURCE_EXTRACTOR
SET fme=%FME2020%
...
REM First FME call, source data with twenty two data records, five records will be output as no geohub url.
set test_number=1
...
set lookup=met\Geohub_ON_URL.xlsx
...
%fme% met\metrique_on_geohub_resource_extractor.fmw ^
--IN_FFS_FILE %source% ^
...
REM Comparison with the standard, non-geospatial data
