REM TEST 1:  5 compliant records FEATURE OUTPUT (5 records)
REM ===========================================================================
...
REM ===========================================================================
SET NomApp=SocrataBoundingBoxCreator
SET fme=%FME2019%
...
REM Test 1: 5 Compliant Records
set test_number=1
...
%fme% met\metrique_SocrataBoundingBoxCreator.fmw ^
--IN_FFS_FILE %source% ^
