...
REM First FME call to source ffs file that has five records with a non-wms url and wms format, and five that have a wms url and wms format
set test_number=1
...
%fme% met\metrique_format_validator.fmw ^
--IN_FFS_FILE %source% ^
