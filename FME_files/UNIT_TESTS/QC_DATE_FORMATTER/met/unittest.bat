...
REM FME call, testing ten QC data records with every possible date permutation 
set test_number=1
...
%fme% met\metrique_qc_date_formatter.fmw ^
--IN_FFS_FILE_1 %source% ^
