...
set test_url=https://geodiscover.alberta.ca/geoportal/rest/metadata/item/@Value(id)/xml
...
SET Statut=%Statut%%ERRORLEVEL%
FIND "ERROR  converting metadata to HNAP" %log%
SET Statut=%Statut%%ERRORLEVEL%
FIND "Feature without resources" %log%
SET Statut=%Statut%%ERRORLEVEL%

REM Second FME call.  Source data for testing is an FFS file containing the preliminary query results performed by catalogue reader transformer.  
REM An error in the Query url is added to throw error
set test_number=1
SET source=met\source%test_number%.ffs
set etalon=met\etalon%test_number%.ffs
set resultat=met\resultat.ffs
set log=met\log_%test_number%.log
set log_comp=met\log_comp_%test_number%.log
set test_url=http://httpstat.us/500
...
--LOG_FILE %log% ^
--GEODISCOVER_URL %test_url%
FIND "ERROR 500.  Unable to call http://httpstat.us/500" %log%
SET Statut=%Statut%%ERRORLEVEL%
