...
REM First FME call, source data with twenty data records, nine geospatial and eleven non-geospatial.  There is also one record with an unmappable TOTO format.
set test_number=1
