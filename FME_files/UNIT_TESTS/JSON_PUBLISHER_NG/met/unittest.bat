...
set json_root_template=met\TBS_ROOT_TEMPLATE.json
set feature_type=ON_JSON_CONFIG
...
%fme% met\metrique_json_publisher_ng.fmw ^
--IN_FFS_FILE %source% ^
--OUT_FFS_FILE %resultat% ^
--JSON_RESOURCE_TEMPLATE %json_resource_template% ^
--JSON_ROOT_TEMPLATE %json_root_template% ^
