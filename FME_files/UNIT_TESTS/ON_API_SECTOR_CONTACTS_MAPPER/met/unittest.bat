...
REM ===========================================================================
SET NomApp=ON_API_SECTOR_CONTACTS_MAPPER
SET fme=%FME2019%
...
set lookup=met\Sector_ON.xlsx
set log=met\log_%test_number%.log
set log_comp=met\log_comp_%test_number%.log

IF EXIST %log% del %log%
IF EXIST met\resultat.ffs DEL met\resultat.ffs
%fme% met\metrique_on_api_sector_contacts_mapper.fmw ^
--IN_FFS_FILE %source% ^
...
set lookup=met\Sector_ON_2.xlsx
set log=met\log_%test_number%.log
set log_comp=met\log_comp_%test_number%.log
...
--LOOKUP_TABLE %lookup% ^
--LOG_FILE %log% 
FIND "Duplicate value Treasury Board Secretariat found in Sector_ON lookup table.  Translation terminated." %log%
SET Statut=%Statut%%ERRORLEVEL%
