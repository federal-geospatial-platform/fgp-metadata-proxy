...
REM ===========================================================================
SET NomApp=GEOSPATIAL_DATA_VALIDATOR_NG
SET fme=%FME2020%
...
set keyword_search=Toponymie
set list_search_attribute=tags{}.display_name
set feature_type=GeoSpatialValidation
...
%fme% met\metrique_geospatial_data_validator_ng.fmw ^
