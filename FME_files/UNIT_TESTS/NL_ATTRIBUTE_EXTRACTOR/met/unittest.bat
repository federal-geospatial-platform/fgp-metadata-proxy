...
REM ===========================================================================
SET NomApp=NL_ATTRIBUTE_EXTRACTOR
SET fme=%FME2020%
...
REM ========================== TEST  #1   ======================================
REM ============================================================================
REM Ce test valide l'extraction des métadonnées à partir du données "XML flatten"
SET test_number=1
...
%fme% met\metrique_nl_attribute_extractor.fmw ^
--IN_FFS_FILE %source% ^
