...
REM ===========================================================================
SET NomApp=ON_API_GEOHUB_RESOURCES_KEYWORDS_MERGER
SET fme=%FME2019%
...
REM FME call, processing data from API (source1) and GEOHUB (source2)
set test_number=1
SET source1=met\source1.ffs
SET source2=met\source1.ffs
...
%fme% met\metrique_on_api_geohub_resources_keywords_manager.fmw ^
