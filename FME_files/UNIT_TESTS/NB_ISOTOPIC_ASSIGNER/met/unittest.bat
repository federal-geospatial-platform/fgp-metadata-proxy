REM TEST 1: 10 compliant records, 7 with dataset-specific isotopic assignment and 3 with generic assignment. FEATURE OUTPUT
...
set lookupdataset=met\TOPICS_DATASET_LOOKUP.csv
set lookupgeneric=met\TOPICS_GENERIC_LOOKUP.csv
...
%fme% met\metrique_NB_ISOTOPIC_ASSIGNER_featureResultat.fmw ^
--IN_FFS_FILE %source% ^
--OUT_FFS_FILE %resultat% ^
--LOOKUP_TABLE_GENERIC %lookupgeneric% ^
--LOOKUP_TABLE_DATASET %lookupdataset% ^
--LOG_FILE %log% 
SET Statut=%Statut%%ERRORLEVEL%
...
IF EXIST %log% del %log%
IF EXIST met\resultat.ffs DEL met\resultat.ffs
%fme% met\metrique_NB_ISOTOPIC_ASSIGNER_errorResultat.fmw ^
--IN_FFS_FILE %source% ^
--OUT_FFS_FILE %resultat% ^
--LOOKUP_TABLE_GENERIC %lookupgeneric% ^
--LOOKUP_TABLE_DATASET %lookupdataset% ^
