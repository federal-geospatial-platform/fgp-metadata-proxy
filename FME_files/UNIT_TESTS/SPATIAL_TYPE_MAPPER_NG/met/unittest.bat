...
REM ===========================================================================
SET NomApp=SPATIAL_TYPE_MAPPER_NG
SET fme=%FME2020%
...
REM ========================== TEST  #1   ======================================
REM ============================================================================
REM First FME call,creating FFS File with 7 compliant data records + 1 error

set test_number=1
set etalon=met\etalon%test_number%.ffs
set resultat=met\resultat%test_number%.ffs
set feature_type=UUID_Spatial_QC
...
%fme% met\metrique_spatial_type_mapper_ng.fmw ^
