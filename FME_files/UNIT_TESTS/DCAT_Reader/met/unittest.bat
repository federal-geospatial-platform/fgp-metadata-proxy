...
SET geo_hub_service="Custom GeoHub"
SET custom_primary="http://localhost:5000/primary/catalogue/data.json"
SET custom_secondary="http://localhost:5000/secondary/catalogue?filter[owner]=Manitoba_Government&page[number]=1&page[size]=25"

IF EXIST %log% del %log%
IF EXIST %resultat% DEL %resultat%
%fme% met\metrique_DCAT_Reader_1.fmw ^
--GEO_HUB_SERVICE %geo_hub_service% ^
