...
REM ===========================================================================
SET NomApp=GMD_SECTION_DATA_EXTRACTION
SET fme=%FME2019%
...
REM First FME call,creating FFS File with eight compliant data records
set test_number=1
...
%fme% met\metrique_gmd_section_data_extraction.fmw ^
--IN_FFS_FILE %source% ^
