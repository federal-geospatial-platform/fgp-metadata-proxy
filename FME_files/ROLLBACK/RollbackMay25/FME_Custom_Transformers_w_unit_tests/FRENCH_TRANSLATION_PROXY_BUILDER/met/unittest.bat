...
REM ===========================================================================
SET NomApp=FRENCH_TRANSLATION_PROXY_BUILDER
SET fme=%FME2019%
...
REM First FME call,creating FFS File nine four compliant data records
set test_number=1
...
%fme% met\metrique_french_translation_proxy_builder.fmw ^
--IN_FFS_FILE %source% ^
